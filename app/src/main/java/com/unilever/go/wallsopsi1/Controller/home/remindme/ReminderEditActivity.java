...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    public static String id_event_api = "";
...
//                ReminderEditActivity.is_this.finish();
//                return;
//
//            }
//        });
//    }
    ...
    public void updateReminder(){
        ...
        Log.d(ReminderAddActivity.class.getSimpleName(),"emailcuk = " + email);
...
//        Log.d(ReminderAddActivity.class.getSimpleName(),"mActive = " + mActive);
        if(mActive.equals("true")){
            Log.d("masuk true", mActive);
            mActive = "1";
        }else{
            Log.d("masuk false", mActive);
            mActive = "0";
        }
        Log.d("mactivenya", mActive);
        Call<EventClassJson> call = api.updateEvent(id_event_api,email,"1", mTitle,mDate,mTime,mActive,login.dataUser.getId());
