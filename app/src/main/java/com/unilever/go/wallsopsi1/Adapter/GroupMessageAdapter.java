...
import com.unilever.go.wallsopsi1.Activity.VideoViewActivity;
import com.unilever.go.wallsopsi1.AsyncTask.DownloadFile;
import com.unilever.go.wallsopsi1.Contracts.StringContract;
import com.unilever.go.wallsopsi1.CustomView.CircleImageView;
import com.unilever.go.wallsopsi1.CustomView.StickyHeaderAdapter;
import com.unilever.go.wallsopsi1.Helper.CCPermissionHelper;
import com.unilever.go.wallsopsi1.R;
import com.unilever.go.wallsopsi1.Utils.DateUtils;
import com.unilever.go.wallsopsi1.Utils.FileUtils;
import com.unilever.go.wallsopsi1.Utils.FontUtils;
import com.unilever.go.wallsopsi1.Utils.Logger;
import com.unilever.go.wallsopsi1.ViewHolders.LeftAudioViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.LeftFileViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.LeftImageVideoViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.LeftMessageViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.LeftReplyViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.RightAudioViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.RightFileViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.RightImageVideoViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.RightMessageViewHolder;
import com.unilever.go.wallsopsi1.ViewHolders.RightReplyViewHolder;
...
import static com.unilever.go.wallsopsi1.Utils.FileUtils.getFileExtension;
import static com.unilever.go.wallsopsi1.Utils.FileUtils.getFileName;
