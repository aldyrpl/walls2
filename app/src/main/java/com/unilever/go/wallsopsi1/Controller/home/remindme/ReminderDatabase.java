...
public class ReminderDatabase extends SQLiteOpenHelper {
    ...
    private static final String KEY_ID_API = "id_api";
    ...
    public int addReminder(Reminder reminder){
        ...
        values.put(KEY_ID_API, reminder.getID_API());
    ...
    public List<Reminder> getAllReminders(){
        ...
        // Select all Query
        String selectQuery = "SELECT * FROM " + TABLE_REMINDERS + " ORDER BY " + KEY_ID_API + " ASC";
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                reminder.setID_API(cursor.getString(8));
    ...
    public int updateReminder(Reminder reminder){
        ...
        values.put(KEY_REPEAT_TYPE, reminder.getRepeatType());
        values.put(KEY_ACTIVE, reminder.getActive());
//        values.put(KEY_IACTIVE, reminder.getActive());
