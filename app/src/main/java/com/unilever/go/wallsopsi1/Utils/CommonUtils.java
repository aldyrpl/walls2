package com.unilever.go.wallsopsi1.Utils;
...
import com.unilever.go.wallsopsi1.Activity.IncomingCallActivity;
import com.unilever.go.wallsopsi1.R;
import com.unilever.go.wallsopsi1.Activity.CreateGroupActivity;
...
public class CommonUtils {
    ...
    @SafeVarargs
    public static void startActivityIntent(Group group, Context context, boolean flag, @Nullable Pair<View,String> ...pairs) {
